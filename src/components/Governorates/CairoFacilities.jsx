...
function CairoFacilities() {
  const navigate = useNavigate();
  
  //  البحث في خريطة القاهرة 
  const [activeMap, setActiveMap] = useState("hospitals in Cairo");

  const facilities = [
    { id: 1, category: "المستشفيات والخدمات الطبية", icon: "🏥", color: "#e74c3c", searchQuery: "hospitals in Cairo", nearbyLink: "https://www.google.com/maps/search/hospitals+near+me", items: ["مستشفى قصر العيني", "مستشفى عين شمس التخصصي", "مركز مجدي يعقوب"] },
    { id: 2, category: "التعليم والجامعات", icon: "🎓", color: "#2980b9", searchQuery: "universities in Cairo", nearbyLink: "https://www.google.com/maps/search/universities+near+me", items: ["جامعة القاهرة", "الجامعة الأمريكية", "جامعة عين شمس"] },
    { id: 3, category: "النقل والمواصلات", icon: "🚇", color: "#f39c12", searchQuery: "metro stations Cairo", nearbyLink: "https://www.google.com/maps/search/transportation+near+me", items: ["مترو الأنفاق", "محطة مصر (رمسيس)", "مواقف الأتوبيس الذكي"] },
    { id: 4, category: "المرافق والخدمات الحكومية", icon: "🏢", color: "#27ae60", searchQuery: "government offices Cairo", nearbyLink: "https://www.google.com/maps/search/government+services+near+me", items: ["مجمع التحرير", "مقر رئاسة الوزراء", "السجل المدني"] },
    { id: 5, category: "النوادي والمنشآت الرياضية", icon: "⚽", color: "#8e44ad", searchQuery: "sports clubs in Cairo", nearbyLink: "https://www.google.com/maps/search/sports+clubs+near+me", items: ["النادي الأهلي", "نادي الزمالك", "ستاد القاهرة الدولي"] },
    { id: 6, category: "التسوق والمراكز التجارية", icon: "🛍️", color: "#d35400", searchQuery: "malls in Cairo", nearbyLink: "https://www.google.com/maps/search/shopping+malls+near+me", items: ["كايرو فيستيفال سيتي", "مول العرب", "سيتي ستارز"] }
  ];
    ...
    <div style={pageWrapper}>
      ...
      <div style={heroSection}>
        <div style={heroOverlay}>
          <h1 style={heroTitle}>مرافق محافظة القاهرة</h1>
          <p style={heroSubtitle}>دليلك الذكي للوصول إلى أهم الخدمات الحيوية والمنشآت في قلب العاصمة المصرية</p>
          <button 
      ...
      <div style={containerStyle}>
        ...
        <div id="map-explorer" style={mapSectionStyle}>
          ...
          <div style={{ flex: 2, height: '500px', borderRadius: '25px', overflow: 'hidden', boxShadow: '0 10px 30px rgba(0,0,0,0.1)' }}>
            <iframe 
              title="Cairo Map"
              src={`https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d110502.60389531818!2d31.2357!3d30.0444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s${encodeURIComponent(activeMap)}!5e0!3m2!1sar!2seg!4v1710000000000!5m2!1sar!2seg`}
        ...
        {/* زر الرجوع:*/}
        <button onClick={() => navigate(-1)} style={backBtnStyle}>العودة لصفحة القاهرة الرئيسية</button>
      </div>
    </div>
  );
}
...
const heroSection = {
  height: '75vh',
  backgroundImage: 'url("https://i.pinimg.com/1200x/62/49/fc/6249fc7eb25acf9a73fb2798dce69ecc.jpg")',
...
const heroOverlay = { backgroundColor: 'rgba(0,0,0,0.55)', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '20px', textAlign: 'center' };
...
export default CairoFacilities;